      ...
      <div className="mb-6">
          ...
          {analysisType === 'sales' && (
            <ResponsiveContainer width="100%" height="100%">
              <LineChart data={salesData}>
                ...
                <Tooltip />
                <Legend />
                <Line type="monotone" dataKey="sales" stroke="#6366F1" name="Umsatz (€)" />
                <Line type="monotone" dataKey="target" stroke="#F59E0B" strokeDasharray="5 5" name="Ziel (€)" />
              </LineChart>
            </ResponsiveContainer>
          )}
          ...
          {analysisType === 'products' && (
            <ResponsiveContainer width="100%" height="100%">
              <BarChart data={productData}>
                ...
                <Tooltip />
                <Legend />
                <Bar dataKey="sales" name="Umsatz (€)" fill="#6366F1" />
                <Bar dataKey="profit" name="Gewinn (€)" fill="#10B981" />
              </BarChart>
            </ResponsiveContainer>
          )}
        ...
        {insight && (
          <div className="mt-6 p-4 bg-indigo-50 border border-indigo-100 rounded-lg">
            <h4 className="font-semibold text-lg text-indigo-800 mb-2">KI-generierter Insight:</h4>
